...
from olaf_robot.hwi import HWI
...
DT = 0.01
REFINE = 10
model_filename = "../../olaf_robot/robots/Olaf/robot.urdf"
...
if args.pybullet:
    ...
    Olaf_mujoco_server = OlafMujocoServer(
        model_path="../../olaf_robot/robots/Olaf", gravity_on=True
    )
...
while True:
    ...
    if args.robot or args.mujoco:
        ...
        if Olaf_mujoco_server.key_pressed is not None:
            got_input = True
            d_x = 0.05
        else:
            got_input = True
