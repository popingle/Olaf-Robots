...
import time
from olaf_robot.utils.rl_utils import mujoco_to_isaac
import json
...
pwe = PlacoWalkEngine(
    "../../../olaf_robot/robots/Olaf/robot.urdf", ignore_feet_contact=True
)
...
model = mujoco.MjModel.from_xml_path("../../../olaf_robot/robots/Olaf/scene.xml")
...
while True:
    ...
    while not done:
        ...
        if time.time() - start > EPISODE_LENGTH * 2:
            ...
            # save json as Olaf_walk.txt
            with open("Olaf_walk.txt", "w") as f:
