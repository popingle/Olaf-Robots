...
from olaf_robot.placo_walk_engine import PlacoWalkEngine
from olaf_robot.utils.mujoco_utils import check_contact, get_contact_force

FRAME_SKIP = 4


class OlafEnv(MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, **kwargs):
        ...
        self.pwe = PlacoWalkEngine(
            "/home/antoine/MISC/olaf_robot/olaf_robot/robots/Olaf/robot.urdf",
        ...
        MujocoEnv.__init__(
            self,
            "/home/antoine/MISC/olaf_robot/olaf_robot/robots/Olaf/scene.xml",
            FRAME_SKIP,
