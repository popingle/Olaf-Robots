from olaf_robot.placo_walk_engine.placo_walk_engine import PlacoWalkEngine
import time
import json
import mujoco
...
decimation = 10
pwe = PlacoWalkEngine(
    "/home/antoine/MISC/olaf_robot/olaf_robot/robots/Olaf_Robots_v2",
    model_filename="robot.urdf",
    init_params=json.load(open("placo_defaults.json")),
    ignore_feet_contact=True,
)
model = mujoco.MjModel.from_xml_path(
    "/home/antoine/MISC/openOlafminiv2_playground/env/locomotion/Olaf_Robots_v2/xmls/scene_mjx_flat_terrain.xml"
)
