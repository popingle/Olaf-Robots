...
> This sould be done independently on each motor *before* builiding the Olaf.
>
...
Clone and install (`pip install -e .`) the runtime repo on the `v2` branch : `https://github.com/olaf-robotics/Olaf_Robots_Runtime`
