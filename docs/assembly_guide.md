...
> Before assembling the Olaf, you should first [configure your motors](./configure_motors.md)
...
Your Olaf should now look like this 
...
<table>
  <tr>
    <td> <img src="Olaf_Robots_v2_wiring_diagram.png" alt="1" width="500px" ></td>
...
> Now that your Olaf is fully assembled, you setup the raspberry pi and the runtime software [here](https://github.com/olaf-robotics/Olaf_Robots_Runtime)
